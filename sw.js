...
const CACHE_NAME = 'wesnoth-timeline-v1.2.1';
const urlsToCache = [
	'/',
	'/index.html',
	...
	'/assets/screenshots/pwa-screenshots/screenshot-desktop.png',
	'/assets/screenshots/pwa-screenshots/screenshot-mobile.png'
];
